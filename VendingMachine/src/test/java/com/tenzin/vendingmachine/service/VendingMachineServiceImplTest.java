...
//        VendingMachineItems testClone = new VendingMachineItems("KurKure", new BigDecimal("2.99"), 10);
//        //ACT
//        BigDecimal insertedMoney = new BigDecimal("5");
//        Map<ChangeAmounts, Integer> mapForChange = service.calculateChange(testClone.getItemCost(), insertedMoney);
//
//        assertEquals(0, mapForChange.values().toArray()[1]);
//        assertEquals(1, mapForChange.values().toArray()[3]);
//    }
